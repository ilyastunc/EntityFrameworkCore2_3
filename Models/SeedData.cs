        ...
        public static void Seed(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product() {Name="Product 3", Description="Product Description 3", Price=300, Category="Category 2"},
                    new Product() {Name="Product 4", Description="Product Description 4", Price=400, Category="Category 2"},
